...
@WebServlet("/Search_Liu")
public class Search_Liu extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         DBConnection_Liu.getDBConnection();
         connection = DBConnection_Liu.connection;
         ...
         out.println("<a href=/webproject_Q2_Liu_0219/search_Liu.html>Search Data</a> <br>");
